    ...
    <div style={isMobile ? styles.rootMobile : styles.root}>
      {isMobile && (
        <div style={styles.mobileTopbar}>
          ...
          >
            <span style={styles.hamburgerIcon}>{sidebarOpen ? "\u2715" : "\u2630"}</span>
          </button>
      ...
      {isMobile ? (
        <>
          ...
          >
            <Sidebar active={activeNav} setActive={handleSetActiveNav} onLogout={onLogout} />
          </div>
        </>
      ) : (
...
const styles: Record<string, CSSProperties> = {
  ...
  main: { flex: 1, display: "flex", flexDirection: "column", background: "#fff", borderRadius: 12, overflow: "hidden" },
  mainMobile: { flex: 1, display: "flex", flexDirection: "column", background: "#fff", overflow: "hidden" },
  header: {
    background: "#fff",
    padding: "14px 28px",
    display: "flex",
