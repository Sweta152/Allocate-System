      ...
      <div style={styles.tableWrap}>
        <table style={styles.table}>
          ...
          <tbody>
            {filtered.length === 0 ? (
              <tr>
                <td colSpan={6} style={styles.emptyState}>No admins found.</td>
              </tr>
            ) : (
              filtered.map((row, i) => (
...
const styles: Record<string, CSSProperties> = {
  ...
  refreshBtn: { display: "inline-flex", alignItems: "center", gap: 6, padding: "8px 16px", borderRadius: 6, border: "1.5px solid #d1d5db", background: "#fff", cursor: "pointer", fontSize: 13, fontWeight: 600, color: "#374151" },
  ...
  tableWrap: { width: "100%", overflowX: "auto", borderRadius: 10, border: "1px solid #e5e7eb", boxShadow: "0 1px 4px rgba(0,0,0,0.06)", WebkitOverflowScrolling: "touch" },
